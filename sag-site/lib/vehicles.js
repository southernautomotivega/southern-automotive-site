...
const VEHICLES = [
  { id: 1, stock: "SAG1001", vin: "1FTEW1EP0KFA00001", year: 2019, make: "Ford", model: "F-150 XLT", price: 27995, miles: 58200, type: "Truck", trans: "Automatic", fuel: "Gas" },
  { id: 2, stock: "SAG1002", vin: "2T3P1RFV0LC000002", year: 2020, make: "Toyota", model: "RAV4 XLE", price: 24450, miles: 41300, type: "SUV", trans: "Automatic", fuel: "Gas" },
  { id: 3, stock: "SAG1003", vin: "3GCUKREC0JG000003", year: 2018, make: "Chevrolet", model: "Silverado 1500", price: 25995, miles: 71900, type: "Truck", trans: "Automatic", fuel: "Gas" },
  { id: 4, stock: "SAG1004", vin: "1HGCV1F30MA000004", year: 2021, make: "Honda", model: "Accord Sport", price: 21900, miles: 33500, type: "Sedan", trans: "Automatic", fuel: "Gas" },
  { id: 5, stock: "SAG1005", vin: "1C4HJXDG0HW000005", year: 2017, make: "Jeep", model: "Wrangler Unlimited", price: 26500, miles: 62100, type: "SUV", trans: "Manual", fuel: "Gas" },
  { id: 6, stock: "SAG1006", vin: "3GTU2NEC0KG000006", year: 2019, make: "GMC", model: "Sierra 1500 SLE", price: 28995, miles: 49700, type: "Truck", trans: "Automatic", fuel: "Gas" },
  { id: 7, stock: "SAG1007", vin: "4S4BTANC0L3000007", year: 2020, make: "Subaru", model: "Outback Premium", price: 23400, miles: 38900, type: "SUV", trans: "Automatic", fuel: "Gas" },
  { id: 8, stock: "SAG1008", vin: "1N4BL4BV0JC000008", year: 2018, make: "Nissan", model: "Altima SV", price: 16995, miles: 54200, type: "Sedan", trans: "Automatic", fuel: "Gas" },
  { id: 9, stock: "SAG1009", vin: "1C4RJKBG0RC000009", year: 2024, make: "Jeep", model: "Grand Cherokee 4xe", price: 26995, miles: 46322, type: "SUV", trans: "Automatic", fuel: "Hybrid", image: "/vehicles/jeep-grand-cherokee-4xe.jpg" },
];

// NOTE: the sample VINs above are placeholders (not real vehicles), so their
// auto-decode results are unreliable — that's why trans/fuel are filled in
// manually below as a safety net. Once you replace a listing with a real
// VIN, you can delete its manual `trans`/`fuel` and let auto-decode fill
// them in correctly — or just leave your manual values in place if you'd
// rather not think about it. Either way works.
...
const TEAM = [
  { id: 1, name: "Nathan Hereford", role: "Managing Partner", initials: "NH", bio: "After five years in automotive sales, Nathan founded Southern Automotive Group with a simple goal: to provide a better car-buying experience. He brings his industry experience and passion for customer service into the dealership every day, personally working with customers and overseeing day-to-day operations to ensure every vehicle and every customer receives the attention they deserve." },
  ...
  { id: 4, name: "Brayden Hereford", role: "Detailing Manager", initials: "BH", bio: "Brayden is a full time highschool student here in Rabun County and is a hardworking young man, however if a vehicle you come to see is not clean this is the man to complain to." },
];
